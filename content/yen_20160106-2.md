...
目前 17.101 總計啟動 IPV4 與 IPV6 網路設定, 安裝了 Nginx 與 uwsgi, 分別在 port 80 與 88 執行 CMSimply, 並在 <https://140.130.17.101:9443> 安裝 Jupyterhub, 只是 IPv6 模式下的 Jupyterhub 還無法使用.
