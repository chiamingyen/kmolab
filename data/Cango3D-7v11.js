...
/*      if (grabbedObj.dragNdrop !== null)
      {
        this.parent = grabbedObj;      // the Obj3D that got the event (this.target may be a Group3D)
      }
...
*/
  ...
  Cango3D.prototype.render = function(rootObj)  // Obj3D or Group3D, 'wireframe', 'noclear' strings accepted
  {
    ...
    function applyXfms(obj)
    {
      ...
      {
        obj.grpTfm = grp.netTfm;  // grpTfm is always netTfm of the parent Group3D
      }
      if (obj.type === "GROUP")
      {
